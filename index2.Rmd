...
---
### Un schéma de données : à quoi ça ressemble ?

Voici un exemple de schéma suivant la spécification Table Schema, le schéma lui-même suit un standard. Son contenu 
